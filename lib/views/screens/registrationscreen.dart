...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: const Text("Registration From")),
        body: Center(
  ...
  loadEula() async {
    ...
    print(eula);
    //https://www.eulatemplate.com/live.php?token=Ak3j1j22J8I6Vy7JOfepq4LkgloieXvv
  }
  ...
  void _registerUser(String name, String email, String phone, String pass) {
    try {
      http.post(Uri.parse("${Config.SERVER}/php/registerdata_users.php"),
          body: {
            "name": name,
            "email": email,
            "phone": phone,
