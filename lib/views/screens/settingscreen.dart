...
import 'package:ksafeapp/config.dart';
...
class _SettingScreenState extends State<SettingScreen> {
                        ...
                        Flexible(
                          ...
                          child: SizedBox(
                              ...
                              child: GestureDetector(
                                onTap: isDisable ? null : _updateImage,
                                child: Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(5, 5, 5, 5),
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        "http://10.19.48.36/fluttermobileapp/ksafeappdb/assets/images/profileimages/${widget.user.id}.png?v=$val",
                    ...
                    children: [
                      ...
                      Expanded(
                          child: ListView(
                              ...
                              children: [
                            MaterialButton(
                              onPressed: isDisable ? null : _updateName,
                            ...
                            MaterialButton(
                              onPressed: isDisable ? null : _updatePhone,
                              child: const Text("UPDATE PHONE"),
                            ),
                            MaterialButton(
                              onPressed: isDisable ? null : _changePass,
                            ...
                            MaterialButton(
                              onPressed: isDisable ? null : _logout,
  ...
  void _updateProfileImage(image) {
    ...
    http.post(
        Uri.parse(
            "http://10.19.48.36/fluttermobileapp/ksafeappdb/php/update_profile.php"),
        body: {
  ...
  void _updatenewName(String newname) {
    http.post(
        Uri.parse(
            "http://10.19.48.36/fluttermobileapp/ksafeappdb/php/update_profile.php"),
        body: {
  ...
  void _updatenewPhone(String newphone) {
    http.post(
        Uri.parse(
            "http://10.19.48.36/fluttermobileapp/ksafeappdb/php/update_profile.php"),
        body: {
