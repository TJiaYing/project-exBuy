...
class _ProfileScreenState extends State<ProfileScreen> {
                            ...
                            child: GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:
                                      "${MyConfig().SERVER}/assets/profileimages/${widget.user.id}.png?v=$val",
                  ...
                  children: [
                    ...
                    Expanded(
                        child: ListView(
                          ...
                          MaterialButton(
                            onPressed: isDisable ? null : _updateEmail,
  ...
  void _updatenewEmail(String newemail) {
    http.post(Uri.parse("${MyConfig().SERVER}/php/update_profile.php"), body: {
      "userid": widget.user.id,
      "newemail": newemail,
    }).then((response) {
